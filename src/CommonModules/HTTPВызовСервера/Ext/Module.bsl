...
Функция ПолучитьИнформациюGET(Запрос) Экспорт
	...
	Спецификация = CloudEventsВызовСервера.JSONEventSpec();
	...
	Иначе
		...
		CloudEventsВызовСервера.ОбогатитьЗаголовки(Ответ.Заголовки);
...
Функция GetReferenceTypes() Экспорт
	...
	ОписаниеМетаданных.Вставить("ReferenceTypes", _ОписаниеВызовСервера.ПодключенныеСправочники());
...
Функция GetDocumentsTypes() Экспорт
	...
	ОписаниеМетаданных = Новый Структура;
	ОписаниеМетаданных.Вставить("DocumentsTypes", _ОписаниеВызовСервера.ПодключенныеДокументы());
...
Функция GetMetadata() Экспорт
	...
	ОписаниеМетаданных.Вставить("v83.http.methods", _ОписаниеВызовСервера.РеализованныеМетоды());
	ОписаниеМетаданных.Вставить("v83.reference.types", _ОписаниеВызовСервера.ПодключенныеСправочники());
	ОписаниеМетаданных.Вставить("v83.documents.types", _ОписаниеВызовСервера.ПодключенныеДокументы());
