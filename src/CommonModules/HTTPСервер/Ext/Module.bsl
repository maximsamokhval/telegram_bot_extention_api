...
Функция ПолучитьИнформациюGET(Запрос) Экспорт
	...
	Спецификация = CloudEventsСервер.JSONEventSpec();
	...
	Иначе
		...
		CloudEventsСервер.ОбогатитьЗаголовки(Ответ.Заголовки);
...
Функция GetReferenceTypes() Экспорт
	...
	ОписаниеМетаданных.Вставить("ReferenceTypes", _ОписаниеСервер.ПодключенныеСправочники());
...
Функция GetDocumentsTypes() Экспорт
	...
	ОписаниеМетаданных = Новый Структура;
	ОписаниеМетаданных.Вставить("DocumentsTypes", _ОписаниеСервер.ПодключенныеДокументы());
...
Функция GetMetadata() Экспорт
	...
	ОписаниеМетаданных.Вставить("v83.http.methods", _ОписаниеСервер.РеализованныеМетоды());
	ОписаниеМетаданных.Вставить("v83.reference.types", _ОписаниеСервер.ПодключенныеСправочники());
	ОписаниеМетаданных.Вставить("v83.documents.types", _ОписаниеСервер.ПодключенныеДокументы());
